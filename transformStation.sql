...
select 1 data_source_id,
       ...
       mdsys.sdo_geometry(2001,8265,mdsys.sdo_point_type(round(site.longitude, 7),round(site.latitude, 7), null), null, null) geom,
       site.station_name, 
       ...
       site.vdatum_id_code,
       site.longitude|| ',' || site.latitude coordinates,
