...
begin
  ...
  execute immediate 'create table organization' || new_suffix || ' as select * from organization_temp@' || dblink;
  ...
  execute immediate 'create table station' || new_suffix || ' as select * from station_temp@' || dblink;
  ...
  execute immediate 'create table activity' || new_suffix || ' as select * from activity_temp@' || dblink;
  ...
  execute immediate 'create table result' || new_suffix || ' as select * from result_temp@' || dblink;
