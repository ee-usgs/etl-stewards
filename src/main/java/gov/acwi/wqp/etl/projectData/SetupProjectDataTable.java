...
@Component
@StepScope
public class SetupProjectDataTable implements Tasklet {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public SetupProjectDataTable(JdbcTemplate jdbcTemplate) {
...
//		jdbcTemplate.execute("create unlogged table org_data_swap_stewards like org_data including comments defaults identity with (fillfactor = 100)");
		jdbcTemplate.execute("truncate table project_data_swap_stewards");
