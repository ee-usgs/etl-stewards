...
import gov.acwi.wqp.etl.orgData.domain.OrgDataProcessor;
import gov.acwi.wqp.etl.orgData.domain.OrganizationRowMapper;
...
public class OrgDataTransformation {
	...
	@Autowired
	@Qualifier("setupOrgDataTable")
	private Tasklet setupOrgDataTable;
	...
	@Bean
	public Step setupOrgDataTableStep() {
		return stepBuilderFactory.get("setupOrgDataTableStep")
				.tasklet(setupOrgDataTable)
				.build();
	}
