...
@Component
@StepScope
public class SetupOrgDataTable implements Tasklet {

	private final JdbcTemplate jdbcTemplate;

	@Autowired
	public SetupOrgDataTable(JdbcTemplate jdbcTemplate) {
...
//		jdbcTemplate.execute("create unlogged table org_data_swap_stewards like org_data including comments defaults identity with (fillfactor = 100)");
		jdbcTemplate.execute("truncate table org_data_swap_stewards");
