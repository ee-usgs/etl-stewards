...
create table if not exists wqp.qwportal_summary_stewards partition of wqp.qwportal_summary for values in (0);
...
create table if not exists wqp.qwportal_summary_stewards_old (like wqp.qwportal_summary_stewards);
...
truncate table wqp.qwportal_summary_stewards_old;
